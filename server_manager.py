...
class ServerManager:
    ...
    def discover_configs(self) -> List[Dict[str, str]]:
        ...
        for file_path in self.server_directory.glob("server-*.properties"):
            ...
            if world_name:
                configs.append({"config_file": config_name, "world_name": world_name})
    ...
    def start_server(self) -> Tuple[bool, str]:
        ...
        try:
            ...
            subprocess.Popen(
                'start "Minecraft Bedrock Server" bedrock_server.exe', cwd=str(self.server_directory), shell=True
            )
